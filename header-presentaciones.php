...
<body <?php body_class(); ?> style="background-color: #000000;
	background-image: url('<?php echo get_template_directory_uri(); ?>/images/fondo-presentaciones.jpg');
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/es_LA/all.js#xfbml=1&appId=267874823355596";
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div id="container" class="container" role="document">
		...
		<div class="row">
			<header id="required-header" class="twelve columns required-header full-column" role="banner">
				<div class="row">
					<div class="eight columns">
						<img src="<?php echo get_template_directory_uri(); ?>/images/logo-quinta.png" alt="De Quinta Producciones" />
						<h1 id="site-title" class="assistive-text">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
						</h1>
						<h4 id="site-description" class="subheader assistive-text"><?php bloginfo( 'description' ); ?></h4>
					</div>
